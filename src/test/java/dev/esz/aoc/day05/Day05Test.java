...
class Day05Test {
    ...
    void part2Test1() {
        ...
        Assertions.assertThat(Day05.part2(numbers, 8)).isEqualTo(0);
    }

    @Test
    void part2Test2() {
        List<Integer> numbers = Utils.readSingleLineToInts("src/main/resources/day05/test2.txt");
        Assertions.assertThat(Day05.part2(numbers, 1)).isEqualTo(0);
    }

    @Test
    void part2Test3() {
        List<Integer> numbers = Utils.readSingleLineToInts("src/main/resources/day05/test3.txt");
        Assertions.assertThat(Day05.part2(numbers, 8)).isEqualTo(1);
    }
    ...
    void part2Test4() {
        List<Integer> numbers = Utils.readSingleLineToInts("src/main/resources/day05/test3.txt");
        Assertions.assertThat(Day05.part2(numbers, 2)).isEqualTo(1);
    }
    ...
    void part2Test7() {
        ...
        Assertions.assertThat(Day05.part2(numbers, 0)).isEqualTo(0);
    }

    @Test
    void part2Test8() {
        List<Integer> numbers = Utils.readSingleLineToInts("src/main/resources/day05/test6.txt");
        Assertions.assertThat(Day05.part2(numbers, 7)).isEqualTo(1);
    }

    @Test
    void part2() {
        List<Integer> numbers = Utils.readSingleLineToInts("src/main/resources/day05/input.txt");
        Assertions.assertThat(Day05.part2(numbers, 5)).isEqualTo(1);
    }
}
